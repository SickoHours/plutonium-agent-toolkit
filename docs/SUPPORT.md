...
| `workspace catalog` | inert | offline | core | Source-labelled records and optional HUD, per-item menu and wallbuy icon bindings; tests/test_workspace_catalog.py covers malformed shapes, registry links, snapshot hashing and aggregate image/row limits. No native qualification receipt; no backend or game actions. |
