...
PLANNED = [
    ...
    Route("registry", "list", "List the registries recorded on this machine", "inert", status="implemented", owner=OWNER),
    Route("registry", "search", "Search recorded registries by words, category, kind, tag, base or map", "inert",
          status="implemented", owner=OWNER, notes="Arguments: [words]... [--category --kind --tag --base --map --entry-kind]. Reads local copies only."),
