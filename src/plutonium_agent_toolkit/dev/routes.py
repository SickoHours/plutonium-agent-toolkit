...
register(Route("module", "changelog", "Generate one module's CHANGELOG.md from its own git history and its evidence ledger, grouped by the version each commit declared", "writes-output", status="implemented", owner=OWNER,
