"""Registered capture and test routes.

Deferred by product decision on 2026-09-10: development tools and game control ship
first. The contracts stay registered so the names are reserved and the manifest is
honest about what is not coming in this release. Every route answers not_implemented.
"""
