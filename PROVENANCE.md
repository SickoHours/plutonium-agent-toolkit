...
| `game/routes.py` contract | `shared/plutonium-control/windows/cli.py` (0.1.0-preview.1) and `plutonium-dev-toolkit/gameplay` | game-modding `3d06b09c0a8831cb71b9b901b4193c0422bf720e`, gaming-desktop as above | Route names, effects, load-ID and check-load semantics, no-replay rule. The Win32 console transport will be re-implemented natively by Thread 2 |
